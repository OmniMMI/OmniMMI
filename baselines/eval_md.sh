...
# model_names=("MiniGPT4-Video" "VideoChatGPT" "VideoLLaVA" "VideoChat2" "LLaMA-VID" "PLLaVA" "LLaVA-NeXT-Video" "ShareGPT4Video" "LongVA" "PLLaVA-13B" "PLLaVA-34B")

model_names=("LLaMA-VID-13B" "LongLLaVA" "LongVILA" "VideoLLaMB")

model_names=("LongVILA")

model_names=("LLaVA-NeXT-Video-34B")
